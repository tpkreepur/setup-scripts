...
```bash
curl -fsSL https://raw.githubusercontent.com/<owner>/<repo>/<branch>/unsloth_studio/install.sh | sudo bash
```
...
curl -fsSL https://raw.githubusercontent.com/<owner>/<repo>/<branch>/unsloth_studio/install.sh | sudo bash -s -- --force

# Install runtime only (skip systemd service)
curl -fsSL https://raw.githubusercontent.com/<owner>/<repo>/<branch>/unsloth_studio/install.sh | sudo bash -s -- --skip-service

# Use a custom path under /opt
curl -fsSL https://raw.githubusercontent.com/<owner>/<repo>/<branch>/unsloth_studio/install.sh | sudo bash -s -- --install-dir /opt/unsloth-studio
```
